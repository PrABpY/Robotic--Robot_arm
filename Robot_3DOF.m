function varargout = Robot_3DOF(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Robot_3DOF_OpeningFcn, ...
                   'gui_OutputFcn',  @Robot_3DOF_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Robot_3DOF_OpeningFcn(hObject, eventdata, handles, varargin)
